<template>
	...
	<!-- tab menu -->
      <nav class="navbar has-shadow">
         <div class="container">
            <div class="tabs">
               <a class="navbar-item is-tab is-active" @click="gotoGroupList">
               <span class="icon is-small"><i class="fa fa-globe"></i></span>
               <span>All Groups</span>
               </a>
               <a class="navbar-item is-tab " @click="gotoMyGroup">
            ...
            <div class="columns">
               ...
               <div class="column">
                  <div class="field is-grouped is-grouped-right">
                     <p class="control">
                        <a v-show="this.checkAdmin()" class="button is-success" @click="gotoNewGroup"><span class="icon">
                        ...
                        <article class="media">
                           ...
                           <div class="media-content">
                              ...
                              <p class="field">
                                 ...
                                 <a v-else @click="requestJoin(group.group_id)" class="button is-success">
                                 <span class="icon is-small">
                                 <i class="fa fa-plus"></i>
                                 </span>
                                 <span>Join</span>
...
<script>
	export default {
		...
		methods: {
			...
			fetchGroup:function(){
				this.$http.get('http://slim.amicloud.me/public/api/groups')
					.then(function(response){
			...
			requestJoin:function(idgroup){
				let formData = {
					user_id: this.user_id,
					group_id: idgroup, 
				}

				this.$http.post('http://slim.amicloud.me/public/api/group/join', formData)
					.then(function(response){
						location.reload();
         ...
         gotoNewGroup:function(){
            this.$router.push({path: `/u/${this.$route.params.user_id}/group_add`});
         }
		},
		created:function(){
			this.fetchGroup();
